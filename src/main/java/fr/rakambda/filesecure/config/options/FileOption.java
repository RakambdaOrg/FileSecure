...
import fr.rakambda.filesecure.config.options.file.FolderPerDayOption;
import fr.rakambda.filesecure.config.options.file.FolderPerMonthOption;
import fr.rakambda.filesecure.config.options.file.FolderPerWeekOption;
import fr.rakambda.filesecure.config.options.file.FolderPerYearOption;
import fr.rakambda.filesecure.config.options.file.IfOlderThanOption;
import fr.rakambda.filesecure.config.options.file.NoRenameOption;
import fr.rakambda.filesecure.config.options.file.UniqueFolderPerDayOption;
