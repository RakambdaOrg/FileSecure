...
@JsonTypeName("FolderPerYearTransformer")
@NoArgsConstructor
public class FolderPerYearTransformer implements FileTransformer {
	@NotNull
	@Override
	public Optional<Path> apply(@NotNull Path sourceFile, @NotNull Path originalOutput, @NotNull Path baseOutput, @NotNull Path currentOutput, @NotNull FileMetadata metadata) throws AbandonBackupException{
		...
		return Optional.of(baseOutput.resolve(year).resolve(relative));
	}
