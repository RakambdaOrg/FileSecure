...
class FolderPerMonthTransformerTest{
	private final FolderPerMonthTransformer tested = new FolderPerMonthTransformer();
	...
	void itShouldWork() throws AbandonBackupException{
		...
		assertThat(tested.apply(source, originalOut, base, out, metadata))
				.contains(Paths.get("/path/2023/05/to/my/file.ext"));
	}
}