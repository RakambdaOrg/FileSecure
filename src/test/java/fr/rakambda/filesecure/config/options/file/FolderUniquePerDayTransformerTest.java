...
class FolderUniquePerDayTransformerTest{
	private final FolderUniquePerDayTransformer tested = new FolderUniquePerDayTransformer();
	...
	void itShouldWork() throws AbandonBackupException{
		...
		assertThat(tested.apply(source, originalOut, base, out, metadata))
				.contains(Paths.get("/path/2023-05-12/to/my/file.ext"));
	}
}