...
class FolderPerYearTransformerTest{
	private final FolderPerYearTransformer tested = new FolderPerYearTransformer();
	...
	void itShouldWork() throws AbandonBackupException{
		...
		assertThat(tested.apply(source, originalOut, base, out, metadata))
				.contains(Paths.get("/path/2023/to/my/file.ext"));
	}
}